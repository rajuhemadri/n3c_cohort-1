...
function format ( d ) {
    ...
    let dropTable = '<table class="drilldown" style="width:60%;margin-left:40%">';

    d.age.forEach((count, i) => {
        if (count.age_bracket === "All_Ages")
            return;
        ...
        dropTable += '<tr>'+
            '<td class="dt-right" style="width:12%;padding-right:29px">'+count.ct_covid_positive+'</td>'+
            '<td class="dt-center" style="width:39%;padding-left:130px">'+count.ct_covid_positive_7d+'</td>'+
            '<td class="dt-center" style="width:19%">'+count.ct_covid_positive_7d_hosp+'</td>'+
            '<td class="dt-center" style="width:18%;padding-left:50px">'+med8DrillDown+'</td>'+
            '<td class="dt-right" style="width:10%; padding-right:30px">'+count.age_bracket+'</td>'+
           '</tr>'
    });
...
var ageBreakDowns = {};
$.getJSON("feeds/priority_drug_counts.jsp", function(data){
