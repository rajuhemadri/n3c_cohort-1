...
<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=age_at_visit_start_in_years_int" />
	<jsp:param name="dom_element" value="#misc_age" />
</jsp:include>

<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=Testcount" />
	<jsp:param name="dom_element" value="#misc_test" />
</jsp:include>

<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=BMI" />
	<jsp:param name="dom_element" value="#misc_bmi" />
</jsp:include>

<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=Weight" />
