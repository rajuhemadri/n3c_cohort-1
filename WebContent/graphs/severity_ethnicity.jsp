...
<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=Ethnicity&value=Hispanic or Latino" />
	<jsp:param name="dom_element" value="#ethnicity_hispanic" />
</jsp:include>

<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=Ethnicity&value=Not+Hispanic or Latino" />
	<jsp:param name="dom_element" value="#ethnicity_not" />
</jsp:include>

<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=Ethnicity&value=Missing/Unknown" />
