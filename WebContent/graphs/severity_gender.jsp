...
<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=gender_concept_name&value=FEMALE" />
	<jsp:param name="dom_element" value="#gender_female" />
</jsp:include>

<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=gender_concept_name&value=MALE" />
	<jsp:param name="dom_element" value="#gender_male" />
</jsp:include>

<jsp:include page="../graph_support/verticalBarChart.jsp">
	<jsp:param name="data_page"	value="feeds/serverity_detail.jsp?variable=gender_concept_name&value=Other" />
