...
<div class="row ml">
	<div class="col-xs-12">
		<div class="panel panel-primary">
			...
			models were developed that accurately predict a severe clinical course. These models were developed with data from the first 
			hospital calendar day, aggregated from 34 medical centers nationwide. To avoid immortal time bias, only patients with at least 
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-6">
					...
					<a href="https://github.com/dmlc/xgboost">XG Boost</a> (AUROC 0.87)<br>
