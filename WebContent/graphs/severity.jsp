<ul class="nav nav-tabs" style="font-size:16px;">
	<li class="active"><a data-toggle="tab" href="#severity_misc">Misc</a></li>
	...
	<li><a data-toggle="tab" href="#severity_by_smoking">Smoking Status</a></li>
</ul>

<div class="tab-content">
<div class="tab-pane fade in active" id="severity_misc">
...
<div class="tab-pane fade" id="severity_by_smoking">
	<jsp:include page="severity_smoking.jsp" flush="true" />
</div>
</div>
