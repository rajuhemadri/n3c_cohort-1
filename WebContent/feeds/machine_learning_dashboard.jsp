...
</sql:query>
{
    "headers": [
        ...
        {"value":"ridgeclassifier_feature_rank", "label":"Ridge Classifier", "title":"The Ridge Classifier prepares data for analysis by converting all target variables to with a -1 or 1 in order to perform a statistical method called a Ridge Regression commonly used in machine learning."},
