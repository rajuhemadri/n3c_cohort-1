...
<sql:query var="elements" dataSource="jdbc/N3CCohort">
	...
	from enclave_cohort.table_1__table_of_all_patient_characteristics_by_covid_statu where variable='${param.variable}'<c:if test="${not empty param.value}"> and value='${param.value}'</c:if>;
</sql:query>
